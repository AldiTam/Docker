...
5. Example Web Application (Golang, Node, React, Makefile)

6. Building Container Images (Golang, Node, React)

7. Container Registries

8. Running Containers (Docker Compose)

9. Container Security

10. Interacting with Docker Objects

11. Development Workflow (Golang, Node, React, Makefile, Docker Compose)

12. Deploying Containers (Docker-swarm. Kubernetes)
...
## 10. Interacting with Containers and Other Docker Objects
